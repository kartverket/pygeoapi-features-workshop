...
Vil du kanskje gjøre noen endringer som å endre beskrivelser legge til keywords eller din kontaktinfo? Det kan gjøres i pygeoapi_config.yml filen, etterfulgt av en ```docker compose restart pygeoapi```
